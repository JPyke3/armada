...
grep -Fq 'EFI/systemd/drivers/adtbloaderaa64.efi' "${FINALIZE}"
grep -Fq 'dtbloader/dtbs/qcom' "${FINALIZE}"
grep -Fq 'fdtget -t s' "${FINALIZE}"
grep -Fq 'timeout 5' "${FINALIZE}"
...
grep -Fq '"${WORK}/esp/loader/entries/"' "${FINALIZE}"
grep -Fq '"${WORK}/esp/ostree/"' "${FINALIZE}"
